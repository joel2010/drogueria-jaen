                ...
                <div v-if="currentStep === 1" class="space-y-6">
                    <div>
                        ...
                        <select id="clientType" v-model="formData.clientType"
                            class="mt-1 block w-full pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md shadow-sm sm:max-w-[50%]">
                    ...
                    <div class="grid grid-cols-1 gap-x-8 gap-y-4">
                        <div class="flex flex-col sm:flex-row sm:items-center">
                            ...
                            <select id="bien" v-model="formData.bien"
                                class="w-full sm:w-2/3 pl-3 pr-10 py-2 text-base border-gray-300 focus:outline-none focus:ring-primary focus:border-primary sm:text-sm rounded-md shadow-sm">
