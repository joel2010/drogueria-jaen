<footer class="w-full bg-gray-100 text-gray-800 relative ">
        ...
        <div
            ...
            <nav class="hidden tablet:block mx-auto tablet:mb-7">
                <ul
                    ...
                    <li><a href="/cuidado-en-casa" class="hover:text-cyan-600 transition-colors">Cuidado En Casa</a>
                    </li>
            ...
            <ul
                ...
                <div class="flex items-center tablet:items-center  tablet:flex-col tablet:space-x-0 tablet:mr-0">
                    ...
                    <p class="text-subtitle !font-medium flex flex-col text-center">
                        <a href="mailto:comercial@drogueriajaen.com.pe"
                            class="hover:text-cyan-600 transition-colors">comercial@drogueriajaen.com.pe</a>
                        <a href="mailto:ventas@drogueriajaen.com.pe"
                            class="hover:text-cyan-600 transition-colors">ventas@drogueriajaen.com.pe</a>
                    </p>
                </div>
                <div class="flex items-center tablet:items-center  tablet:flex-col tablet:space-x-0 tablet:mr-0">
                    <div class="flex items-center space-x-2 mx-auto">
                    ...
                    <p class="text-subtitle !font-medium">
                        <a href="https://wa.me/51957390675?text=Hola%2C%20quisiera%20más%20información%20sobre%20sus%20servicios"
                            target="_blank" rel="noopener" class="hover:text-cyan-600 transition-colors">
                            957 390 675
                        </a>
                    </p>
                </div>
    ...
    <div class="tablet:hidden w-full space-y-4 text-center ">
        <div class="border-y border-primary mb-1">
            ...
            <div data-accordion-menu="inicio" class="hidden text-left py-2 px-5">
                <ul class="space-y-2">
                    ...
                    <li><a href="/cuidado-en-casa" class="block hover:text-cyan-600 transition-colors">Cuidado En
                            Casa</a></li>
        ...
        <div class="border-b border-primary">
            ...
            <div data-accordion-menu="contacto" class="hidden text-left py-2 pt-0 px-5">
                <ul class="space-y-2">
                    <li class="mb-0"><a href="#" class="block hover:text-cyan-600 transition-colors">Dirección</a></li>
                    <li><a href="#" class="block hover:text-cyan-600 transition-colors text-description mb-2">Los Olivos
                            - Lima, Perú</a></li>
                    <li class="mb-0"><a href="#" class="block hover:text-cyan-600 transition-colors">Email</a></li>
                    <li class="mb-0">
                        <a href="mailto:comercial@drogueriajaen.com.pe"
                            class="hover:text-cyan-600 transition-colors text-description">comercial@drogueriajaen.com.pe</a>
                    </li>
                    <li class="mb-2">
                        <a href="mailto:ventas@drogueriajaen.com.pe" class="hover:text-cyan-600 transition-colors text-description">ventas@drogueriajaen.com.pe</a>
                    </li>

                    <li class="mb-0"><a href="#" class="block hover:text-cyan-600 transition-colors">Teléfono</a></li>
                    <li><a href="https://wa.me/51957390675?text=Hola%2C%20quisiera%20más%20información%20sobre%20sus%20servicios"
                            target="_blank" rel="noopener"
                            class="hover:text-cyan-600 transition-colors text-description mb-0">957 390 675</a></li>
                </ul>
            </div>
        </div>
    </div>
    ...
    <div
        class="max-width mx-auto mb-12 flex flex-col tablet:flex-row tablet:justify-between items-center place-content-center space-y-4 pt-2 border-black border-t gap-1 tablet:gap-0">
        ...
        <div class="flex flex-col tablet:flex-row items-center space-y-2">
            ...
            <div class="flex space-x-1">
                <a href="https://www.facebook.com/profile.php?id=61563440202360" target="_blank" aria-label="Facebook"
                    class="text-gray-600 hover:text-blue-600 transition-colors tablet:ml-2">
                    <img src="/icons/fb.svg" alt="icono Facebook" class="w-7 h-7">
                </a>
                ...
                <a href="https://www.instagram.com/drogueriajaen?igsh=b2dxMGxpZjd3YXQw" target="_blank"
                    aria-label="Instagram" class="text-gray-600 hover:text-pink-600 transition-colors">
                    <img src="/icons/instagram.svg" alt="icono Instagram" class="w-7 h-7">
                </a>
            </div>
        </div>
    </div>
