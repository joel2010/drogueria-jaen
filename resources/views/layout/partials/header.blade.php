<header class="w-full text-gray-800 z-10 relative">
    ...
    <div id="mobile-menu" class="hidden tablet:hidden bg-primary text-white py-4">
        <ul class="flex flex-col space-y-4 px-4">
            <li><a href="/" class="block py-2 {{ request()->is('/') ? 'text-cyan-300 font-semibold' : 'hover:text-cyan-300 transition-colors' }}">Inicio</a></li>
            <li><a href="/nosotros" class="block py-2 {{ request()->is('nosotros') ? 'text-cyan-300 font-semibold' : 'hover:text-cyan-300 transition-colors' }}">Nosotros</a></li>
            <li><a href="/productos" class="block py-2 {{ request()->is('productos') ? 'text-cyan-300 font-semibold' : 'hover:text-cyan-300 transition-colors' }}">Productos</a></li>
            <li><a href="/servicios" class="block py-2 {{ request()->is('servicios') ? 'text-cyan-300 font-semibold' : 'hover:text-cyan-300 transition-colors' }}">Servicios</a></li>
            <li><a href="/cuidado-en-casa" class="block py-2 {{ request()->is('cuidado-en-casa') ? 'text-cyan-300 font-semibold' : 'hover:text-cyan-300 transition-colors' }}">Cuidado en Casa</a></li>
            <li><a href="/contacto" class="block py-2 {{ request()->is('contacto') ? 'text-cyan-300 font-semibold' : 'hover:text-cyan-300 transition-colors' }}">Contacto</a></li>
        </ul>
    </div>
</header>
