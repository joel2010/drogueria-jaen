...
<section class="mx-auto tablet:py-8 relative max-width">
    ...
    <div class="tablet:hidden relative max-w-desktop mx-auto py-6 px-4 tablet:py-4">
        <div class="glide glide-features">
            <!-- Track -->
                ...
                <ul class="glide__slides">
                    ...
                    <li class="glide__slide">
                        <div class="!bg-[#FAFAFA] rounded-lg shadow-md p-4 flex flex-col items-center text-center h-full mx-4"
                            ...
                            <div class="mb-4"> <img src="{{ $feature['iconSrc'] }}"
                                    alt="icono {{ strtolower($feature['title']) }}" class="w-14 h-14"> </div>
                            <h3 class="text-title mb-2"> {{ $feature['title'] }} </h3>
                            <p class="text-description leading-relaxed mb-auto"> {{ $feature['description'] }} </p>
                        </div>
                    </li>
                    @endforeach
                </ul>
            ...
            <div class="glide__arrows" data-glide-el="controls">
                <button data-glide-dir="<"
                    class="absolute left-0 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full bg-white/70 backdrop-blur-sm shadow-md transition-all duration-300 border border-primary">
                    <img src="/icons/button-left.svg" alt="Anterior" class="w-4 h-4">
                </button>
                <button data-glide-dir=">"
                    class="absolute right-0 top-1/2 -translate-y-1/2 z-10 p-1 rounded-full bg-white/70 backdrop-blur-sm shadow-md transition-all duration-300 border border-primary">
